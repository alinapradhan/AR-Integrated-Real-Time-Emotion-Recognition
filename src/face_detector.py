...
Uses MediaPipe and OpenCV for robust face detection, with OpenCV fallback
"""
...
# Try to import MediaPipe at module level
try:
...
class FaceDetector:
    def __init__(self):
        # Initialize based on MediaPipe availability
